...
if ( ! class_exists('wp_rem_plugin_all_strings_2') ) {
    ...
    class wp_rem_plugin_all_strings_2 {
	    ...
	    $wp_rem_static_text['wp_rem_plugin_options_property_page_slug_option'] = esc_html__('Property Page Slug Option', 'wp-rem');
            ...
            $wp_rem_static_text['wp_rem_plugin_options_demo_user_login'] = esc_html__('Guest User Login', 'wp-rem');
             ...
             * Plugin Settings
             */
            $wp_rem_static_text['wp_rem_plugin_seetings_rem_settings'] = esc_html__('Badu Settings', 'wp-rem');
            ...
            $wp_rem_static_text['wp_rem_rem_wp'] = esc_html__('Property Management', 'wp-rem');
            ...
            $wp_rem_static_text['wp_rem_rem_create_list_text'] = esc_html__('Add Property', 'wp-rem');
            ...
            $wp_rem_static_text['wp_rem_member_dashboard_my_prop'] = esc_html__('Overview', 'wp-rem');
            $wp_rem_static_text['wp_rem_member_dashboard_orders'] = esc_html__('Orders', 'wp-rem');
            $wp_rem_static_text['wp_rem_member_dashboard_enquires'] = esc_html__('Property Enquiries', 'wp-rem');
            $wp_rem_static_text['wp_rem_member_dashboard_alerts_searches'] = esc_html__('Saved Searches and Alerts', 'wp-rem');
            $wp_rem_static_text['wp_rem_member_dashboard_fav_prop'] = esc_html__('Short List Properties', 'wp-rem');

            $wp_rem_static_text['wp_rem_member_dashboard_packages'] = esc_html__('My Plan', 'wp-rem');

            $wp_rem_static_text['wp_rem_member_dashboard_create_properties'] = esc_html__('Manage Properties', 'wp-rem');
            ...
            $wp_rem_static_text['wp_rem_favourite_favourite'] = esc_html__('Short List Properties', 'wp-rem');
            $wp_rem_static_text['wp_rem_favourite_favourite_manage'] = esc_html__('Short List Properties Manage', 'wp-rem');
            $wp_rem_static_text['wp_rem_favourite_fav_added'] = esc_html__('Short List Properties added', 'wp-rem');
            $wp_rem_static_text['wp_rem_favourite_fav_removed'] = esc_html__('Short List Properties removed', 'wp-rem');
            $wp_rem_static_text['wp_rem_favourite_favourite_ur_property'] = esc_html__('Short List Properties your property', 'wp-rem');
            $wp_rem_static_text['wp_rem_favourite_delete_successfully'] = esc_html__('Deleted Successfully', 'wp-rem');
            $wp_rem_static_text['wp_rem_favourite_remove_one_list'] = esc_html__(' removed your property from Short List Properties.', 'wp-rem');
            $wp_rem_static_text['wp_rem_favourite_dont_have_favourite'] = esc_html__('You don\'t have any favourite Short List Properties.', 'wp-rem');
            $wp_rem_static_text['wp_rem_favourite_fav_propert'] = esc_html__('Short List Properties', 'wp-rem');
            $wp_rem_static_text['wp_rem_favourite_dont_hav_fav_propert'] = esc_html__('You don\'t have any Short List Properties.', 'wp-rem');
			...
			$wp_rem_static_text['wp_rem_register_login_demo_user'] = esc_html__('Guest User', 'wp-rem');
			$wp_rem_static_text['wp_rem_plugin_options_demo_user'] = esc_html__('Guest User', 'wp-rem');
			$wp_rem_static_text['wp_rem_plugin_options_demo_user_hint'] = esc_html__('Please select a user for Guest login', 'wp-rem');
