...
// Property Enquiries Strings
            $wp_rem_static_text['wp_rem_property_enquiries'] = esc_html__('Manage Leads', 'wp-rem');
            $wp_rem_static_text['wp_rem_property_enquiries_name'] = esc_html__('Manage Leads', 'wp-rem');
            $wp_rem_static_text['wp_rem_property_enquiries_singular_name'] = esc_html__('Lead', 'wp-rem');
            $wp_rem_static_text['wp_rem_property_enquiries_menu_name'] = esc_html__('Manage Leads', 'wp-rem');
            $wp_rem_static_text['wp_rem_property_enquiries_name_admin_bar'] = esc_html__('Manage Leads', 'wp-rem');
            $wp_rem_static_text['wp_rem_property_enquiries_add_new'] = esc_html__('Add Lead', 'wp-rem');
            $wp_rem_static_text['wp_rem_property_enquiries_add_new_item'] = esc_html__('Add Lead', 'wp-rem');
            $wp_rem_static_text['wp_rem_property_enquiries_new_item'] = esc_html__('Add Lead', 'wp-rem');
            $wp_rem_static_text['wp_rem_property_enquiries_edit_item'] = esc_html__('Edit Lead', 'wp-rem');
            $wp_rem_static_text['wp_rem_property_enquiries_view_item'] = esc_html__('View Leads', 'wp-rem');
            $wp_rem_static_text['wp_rem_property_enquiries_all_items'] = esc_html__('All Leads', 'wp-rem');
            $wp_rem_static_text['wp_rem_property_enquiries_search_items'] = esc_html__('Search Leads', 'wp-rem');
            $wp_rem_static_text['wp_rem_property_enquiries_not_found'] = esc_html__('Leads', 'wp-rem');
            $wp_rem_static_text['wp_rem_property_enquiries_not_found_in_trash'] = esc_html__('Leads', 'wp-rem');
            $wp_rem_static_text['wp_rem_property_enquiries_description'] = esc_html__('Edit Lead', 'wp-rem');
...
// post type packages
            $wp_rem_static_text['wp_rem_post_type_package_name'] = esc_html__('User Plans', 'wp-rem');
            $wp_rem_static_text['wp_rem_post_type_package_singular_name'] = esc_html__('User Plan', 'wp-rem');
            $wp_rem_static_text['wp_rem_post_type_package_menu_name'] = esc_html__('User Plans', 'wp-rem');
            $wp_rem_static_text['wp_rem_post_type_package_name_admin_bar'] = esc_html__('User Plans', 'wp-rem');
            $wp_rem_static_text['wp_rem_post_type_package_add_new'] = esc_html__('Add User Plan', 'wp-rem');
            $wp_rem_static_text['wp_rem_post_type_package_add_new_item'] = esc_html__('Add User Plan', 'wp-rem');
            $wp_rem_static_text['wp_rem_post_type_package_new_item'] = esc_html__('Add User Plan', 'wp-rem');
            $wp_rem_static_text['wp_rem_post_type_package_edit_item'] = esc_html__('Edit User Plan', 'wp-rem');
            $wp_rem_static_text['wp_rem_post_type_package_view_item'] = esc_html__('User Plan', 'wp-rem');
            $wp_rem_static_text['wp_rem_post_type_package_all_items'] = esc_html__('User Plan', 'wp-rem');
            $wp_rem_static_text['wp_rem_post_type_package_search_items'] = esc_html__('User Plan', 'wp-rem');
            $wp_rem_static_text['wp_rem_post_type_package_not_found'] = esc_html__('User Plan', 'wp-rem');
            $wp_rem_static_text['wp_rem_post_type_package_not_found_in_trash'] = esc_html__('User Plan', 'wp-rem');
            $wp_rem_static_text['wp_rem_post_type_package_description'] = esc_html__('Edit User Plan', 'wp-rem');
            $wp_rem_static_text['wp_rem_post_type_package_meta_number_of_services'] = esc_html__('User Plan', 'wp-rem');
// post type Branches
...
// Packages meta
            ...
            $wp_rem_static_text['wp_rem_member_profile_landlord'] = esc_html__('Landlord', 'wp-rem');
            $wp_rem_static_text['wp_rem_member_profile_tenant'] = esc_html__('Tenant', 'wp-rem');
            $wp_rem_static_text['wp_rem_member_profile_builder'] = esc_html__('Builder', 'wp-rem');
            $wp_rem_static_text['wp_rem_member_profile_agency'] = esc_html__('Agency', 'wp-rem');
            $wp_rem_static_text['wp_rem_member_profile_property_manager'] = esc_html__('Property Manager', 'wp-rem');
            ...
            $wp_rem_static_text['redeem_reward_points'] = esc_html__('Redeem Reward points', 'wp-rem');
            $wp_rem_static_text['posted_requirements'] = esc_html__('Posted Requirements', 'wp-rem');
            $wp_rem_static_text['tenant_list'] = esc_html__('Tenant List', 'wp-rem');
            $wp_rem_static_text['statistics'] = esc_html__('Statistics', 'wp-rem');
            $wp_rem_static_text['my_questions'] = esc_html__('My Questions', 'wp-rem');
            $wp_rem_static_text['tenancy_requests'] = esc_html__('Tenancy Requests', 'wp-rem');
            $wp_rem_static_text['agents_following'] = esc_html__('Agents Following', 'wp-rem');
            $wp_rem_static_text['make_payment'] = esc_html__('Make Payment', 'wp-rem');
            $wp_rem_static_text['my_owners'] = esc_html__('My Owners', 'wp-rem');
            $wp_rem_static_text['property_maintenance_requests'] = esc_html__('Property Maintenance Requests', 'wp-rem');
            $wp_rem_static_text['wp_rem_member_manage_properties'] = esc_html__('Create Properties', 'wp-rem');
            $wp_rem_static_text['report'] = esc_html__('Report', 'wp-rem');

            
            $wp_rem_static_text['preferences'] = esc_html__('Preferences', 'wp-rem');
            $wp_rem_static_text['my_flags'] = esc_html__('My Flags', 'wp-rem');
            ...
            $wp_rem_static_text['wp_rem_save_post_location_state'] = esc_html__('State/Region/Province', 'wp-rem');
