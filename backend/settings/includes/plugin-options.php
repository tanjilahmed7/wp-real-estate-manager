        ...
        <div class="theme-wrap fullwidth">
			...
			<div class="col1">
                            <nav class="admin-navigtion">
                                <div class="logo" > <a href="javascript;;" class="logo1" ><img src="' . esc_url(wp_rem::plugin_url()) . 'assets/backend/images/logo.png" style="height:50px;" /></a> <a href="#" class="nav-button"><i class="icon-align-justify"></i></a> </div>
                                <ul>
