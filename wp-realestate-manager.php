...
/*
  ...
  Plugin URI: http://badu-schandorfrealty.com
  Description: WP Real Estate Manager
  Version: 1.8
  Author: Tanjil Ahmed
  Text Domain: wp-rem
  Author URI: http://badu-schandorfrealty.com
  License: GPL2
 */
if (!class_exists('wp_rem')) {
	...
	public function includes() {
	     ...
	     */
       	...
       	// require_once 'shortcodes/frontend/shortcode-propertysearch.php';
       	require_once 'frontend/templates/dashboards/member/tenantcy-req/property-tanant-request.php';
      	require_once 'frontend/templates/dashboards/member/landlord-view.php';
      	require_once 'frontend/templates/dashboards/member/member-builder.php';
      	require_once 'frontend/templates/dashboards/member/property-manager-view.php';
	...
	public function wp_rem_defaultfiles_plugin_enqueue() {
      ...
      // add_action( 'wp_enqueue_scripts', 'register_data_table_styles' );
      //   function register_data_table_styles() {
      //   wp_register_style( 'data-table-bootstrap', "https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.1.1/css/bootstrap.css" );
      //   wp_register_style( 'data-table-css', 'https://cdn.datatables.net/1.10.19/css/dataTables.bootstrap4.min.css' );
      //   wp_enqueue_style( 'data-table-bootstrap' );
      ...
      // }
	    ...
	    wp_enqueue_script('wp-rem-report', plugins_url('/assets/frontend/scripts/wp-rem-report.js', __FILE__), '', '');
      	wp_enqueue_script('wp-rem-landlord', plugins_url('/assets/frontend/scripts/wp-rem-landlord.js', __FILE__), '', '');
       	wp_enqueue_script('property-tenant', plugins_url('/assets/frontend/scripts/property-tenant.js', __FILE__), '', wp_rem::get_plugin_version());
        wp_register_style( 'DataTable', 'https://cdn.datatables.net/1.10.19/css/jquery.dataTables.css' );
        wp_enqueue_style('DataTable');
        wp_register_script( 'DataTablejs', 'https://cdn.datatables.net/1.10.19/js/jquery.dataTables.js', null, null, true );
        wp_enqueue_script('DataTablejs');
       	wp_enqueue_script('select2', plugins_url('/assets/frontend/scripts/select2.min.js', __FILE__), '', wp_rem::get_plugin_version());
	    /*
		...
		wp_enqueue_style('select2', plugins_url('/assets/frontend/css/select2.min.css', __FILE__), '', wp_rem::get_plugin_version());
	    ...
	    wp_register_script('property-tenant', plugins_url('/assets/frontend/scripts/property-tenant.js', __FILE__), '', wp_rem::get_plugin_version());
