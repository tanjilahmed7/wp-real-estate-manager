...
if ( ! class_exists( 'Wp_rem_faqs_frontend' ) ) {
	...
	class Wp_rem_faqs_frontend {
		...
		public function wp_rem_photos_epc_tab_callback( $property_id = '', $property_type_id = '', $photos_epc_tab = array() ) {
			...
			?>
			<li id="wp-rem-property-faqs-holder" style="display: <?php echo ($property_type_faqs == 'on' ? 'block' : 'none') ?>;">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard-element-title">
							...
							<a data-target="#add-faq" data-toggle="modal" class="add-new-faq-btn" href="javascript:void(0);"><?php echo wp_rem_plugin_text_srt( 'wp_rem_property_type_meta_faqs_add_row' ); ?></a>
						</div>
								...
								if ( is_array( $faqs_data ) && sizeof( $faqs_data ) > 0 ) {
									foreach ( $faqs_data as $key => $faq ) {
										...
										<li class="faq faq-<?php echo $counter; ?>">
											...
											<div class="edit-faq"><a href="javascript:void(0);"><?php echo wp_rem_plugin_text_srt( 'wp_rem_memberlist_edit' ); ?></a></div>
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4 class="modal-title" id="faqModalLabel"><?php echo wp_rem_plugin_text_srt( 'wp_rem_property_type_meta_faqs_add_row' ); ?></h4>
									</div>
						...
						<div class="modal fade modal-form" id="edit-faq" tabindex="-1" role="dialog">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close close-faq" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
										<h4 class="modal-title" id="faqModalLabel"><?php echo wp_rem_plugin_text_srt( 'wp_rem_faq_update_faq' ); ?></h4>
									</div>
									<div class="modal-body">
										<div class="row">
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
