...
if ( ! class_exists('wp_rem_payment_calculator_element') ) {
    ...
    class wp_rem_payment_calculator_element {
        ...
        public function wp_rem_payment_calculator_html_callback($property_id = '') {
            ...
            $wp_rem_mortgage_max_year = isset($wp_rem_plugin_options['wp_rem_mortgage_max_year']) && ! empty($wp_rem_plugin_options['wp_rem_mortgage_max_year']) ? $wp_rem_plugin_options['wp_rem_mortgage_max_year'] : '30';
