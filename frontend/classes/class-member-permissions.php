...
if ( ! class_exists( 'Wp_rem_Member_Permissions' ) ) {
	...
	class Wp_rem_Member_Permissions {
		...
		public function member_permissions() {
			...
			$permissions['redeem_reward_points'] = wp_rem_plugin_text_srt( 'redeem_reward_points' );
			$permissions['posted_requirements'] = wp_rem_plugin_text_srt( 'posted_requirements' );
			$permissions['tenant_list'] = wp_rem_plugin_text_srt( 'tenant_list' );
			$permissions['statistics'] = wp_rem_plugin_text_srt( 'statistics' );
			$permissions['my_questions'] = wp_rem_plugin_text_srt( 'my_questions' );
			$permissions['tenancy_requests'] = wp_rem_plugin_text_srt( 'tenancy_requests' );
			$permissions['agents_following'] = wp_rem_plugin_text_srt( 'agents_following' );
			$permissions['make_payment'] = wp_rem_plugin_text_srt( 'make_payment' );
			$permissions['my_owners'] = wp_rem_plugin_text_srt( 'my_owners' );
			$permissions['preferences'] = wp_rem_plugin_text_srt( 'preferences' );
			$permissions['property_maintenance_requests'] = wp_rem_plugin_text_srt( 'property_maintenance_requests' );
			$permissions['wp_rem_member_manage_properties'] = wp_rem_plugin_text_srt( 'wp_rem_member_manage_properties' );
			$permissions['report'] = wp_rem_plugin_text_srt( 'report' );
