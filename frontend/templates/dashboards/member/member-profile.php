...
// Make sure that this file is included, as wp_generate_attachment_metadata() depends on it.
        ...
        public function wp_rem_member_accounts_save() {
            ...
            $wp_rem_user_facebook = $_POST['wp_rem_user_facebook'];
            $wp_rem_user_google_plus = $_POST['wp_rem_user_google_plus'];
            $wp_rem_user_twitter = $_POST['wp_rem_user_twitter'];
            $wp_rem_user_linkedIn = $_POST['wp_rem_user_linkedIn'];
